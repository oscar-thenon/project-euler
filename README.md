...
* I also sometimes include intermediate files such as `pj066_insights.txt`.
* The `pjxxx.txt` files are formatted texts to share my solution on the website's forum.
* A file `primes.txt` containing all prime numbers bellow $10^9$, one per line, is needed for some of the solutions to run. One can create this file by executing `set_primes.sh`.
